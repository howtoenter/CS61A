...
def missing_digits(n):
    ...
    i = 0
    if n >= 10:
        final, last, all_but_last =n % 10, n % 100 // 10, n // 10
        if final != last:
            i += final - last - 1
        return missing_digits(all_but_last) + i
    else:
        return i
...
def count_change(total):
    ...
    #base case, to be simpler
    #1.with small_coin 2.without small_coin
    #when I need extra paramter, just def helper, and return 
